...
public class App {
    ...
    private static final String password = "superhackerpassword";
    private static final String to = "marvel";
...
//        GUI testFrame = new GUI();
        ...
        try (Connection connection = getConnection(connectionPool)) {
            ...
            connection.add().io().format(RDFFormats.N3).stream(new FileInputStream("C:\\Users\\akans\\Downloads\\stardog-examples-develop\\stardog-examples-develop\\examples\\JavaStardogClient\\app\\src\\main\\resources\\marvel.rdf"));
